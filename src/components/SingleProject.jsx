...
export default function SingleProject(props){
   return(
      <div className="project-description sm:flex block mt-8">
            ...
            <div className="project-description_p mt-14 w-full shadow-xl p-8">
                  ...
                  <div className="btn-projects">
                        <button className="p-4 md:mr-12"><a href={props.linkWeb} target="_blank" rel="noreferrer">Live Project</a></button>
